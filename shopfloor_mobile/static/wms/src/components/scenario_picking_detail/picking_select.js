        ...
        <div :class="record.package_dest ? 'has-pack' : 'no-pack'">
            ...
            <div class="qty done">
                ...
                <packaging-qty-picker-display
                    :key="make_component_key(['picking-select', 'qty-picker-widget', 'done', record.id])"
                    :options="utils.misc.move_line_qty_picker_options(record, {init_value: record.qty_done, non_zero_only: true, pkg_name_key: 'code'})"
                    />
            </div>
            <div class="qty reserved">
                <span class="label">Reserved:</span>
                <packaging-qty-picker-display
                    :key="make_component_key(['picking-select', 'qty-picker-widget', 'reserved', record.id])"
