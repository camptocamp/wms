    ...
    template: `
        <Screen :screen_info="screen_info">
            ...
            <div class="button-list button-vertical-list full">
                <v-row align="center" v-if="is_current_location_set()">
                    <v-col class="text-center" cols="12">
                        <btn-action @click="this.reset_current_location">Reset location</btn-action>
                    </v-col>
                </v-row>
        ...
        return {
            ...
            states: {
                ...
                select_document: {
                    ...
                    on_scan: (scanned) => {
                        let endpoint_data = {barcode: scanned.text};
                        this.wait_call(this.odoo.call("scan_deliver", endpoint_data));
                    },
