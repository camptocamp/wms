 ...
 */
import {demotools} from "../demo/demo.core.esm.js";
...
export class OdooMixin {
    ...
    post(path, data, fullpath = false) {
        ...
        const endpoint_info = this._make_endpoint_info(_path, fullpath);
...
export class OdooMocked extends OdooMixin {
    ...
    _call(endpoint_info, method, data) {
        ...
        const barcode = data
            ...
            : null;
        const demo_data = this.demo_data;
    ...
    mocked_user_config(params) {
        return Promise.resolve({data: demotools.makeAppConfig(), params: params});
    }
    mocked_menu(params) {
        return Promise.resolve({
            data: {menus: demotools.getAppMenus(), params: params},
        });
    }
    mocked_scan(params) {
        const result = {};
